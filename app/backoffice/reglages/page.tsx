            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <AdminField
                  ...
                  defaultValue="artemis.inscriptions@gmail.com"
                />
                <AdminField label="Téléphone" defaultValue="07 78 47 22 30" />
              </div>
              <AdminField
                label="Adresse postale"
                defaultValue="22 rue des Épinettes, 95180 Menucourt"
              />
          ...
          {sec === "equipe" && (
            <>
              ...
              <div className="mt-6 bg-paper border border-dashed border-ink/20 rounded-[2px] p-4">
                <AdminEyebrow className="mb-2">Invitations en attente</AdminEyebrow>
