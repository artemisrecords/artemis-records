...
export function ArtistesListClient({ artists }: { artists: Artist[] }) {
          ...
          {artists.map((a) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(180deg, rgba(28,31,74,0.05), rgba(28,31,74,0.45)), url(${a.coverUrl})`,
                }}
              >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 pt-4 border-t border-ink/10 grid grid-cols-3 gap-3 text-center">
                  <MiniStat label="Signé" value={a.signedYear} />
            ...
            {artists.map((a, i) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: `url(${a.portraitUrl})` }}
                />
                <div>
                ...
                <div className="text-[13px]">{a.signedYear}</div>
                <Pill tone={a.published ? "live" : "draft"}>
                  {a.published ? "En ligne" : "Brouillon"}
                </Pill>
                <Link
