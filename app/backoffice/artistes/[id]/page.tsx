    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-paper-soft border border-ink/10 rounded-[2px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(180deg, rgba(28,31,74,0.1), rgba(28,31,74,0.55)), url(${artist.cover})`,
          }}
        >
          ...
          {tab === "identite" && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <AdminField label="Slug URL" defaultValue={artist.slug} hint="Utilisé dans l'URL publique" />
              </div>
              <AdminField
          ...
          {tab === "medias" && (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[artist.portrait, artist.cover, ...artist.gallery].map(
                  (src, i) => (
                    <div
                      key={i}
