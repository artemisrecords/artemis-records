...
import { ARTISTS, NEWS, formatDate } from "@/lib/data";
            ...
            {news.slice(0, 3).map((n) => (
              ...
              >
                <div
                  ...
                  style={{ background: `center/cover no-repeat url(${n.image})` }}
                />
                <div>
      ...
      <section className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] min-h-[84vh] items-stretch">
        ...
        {featured && (
          <Link
            ...
            style={{
              backgroundImage: `linear-gradient(180deg, rgba(28,31,74,0.1), rgba(28,31,74,0.5)), url(${featured.cover})`,
...
function HomeImmersive({ artists }: { artists: typeof ARTISTS }) {
      ...
      <section className="relative overflow-hidden bg-bleu-nuit-900 h-[90vh]">
        ...
        {artists.map((a, i) => (
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(180deg, rgba(28,31,74,0.25) 0%, rgba(28,31,74,0.85) 100%), url(${a.cover})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
              opacity: i === slide ? 1 : 0,
            }}
